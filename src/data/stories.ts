...
export const stories: Story[] = [
  {
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['这碗汤不是起点。', '男人遭遇过海难。', '关键在旧说法真假。'],
    },
    tags: ['餐桌谜案', '深海求生', '身体代价'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 30,
      hintCost: 10,
      items: ['别只看当前天气。', '这些东西曾属于整体。', '关键是形态改变。'],
    },
    tags: ['童话黑箱', '荒野遗物', '时间错觉'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['别默认房间一直如此。', '那摊水曾有用途。', '关键物体会消失。'],
    },
    tags: ['血色密室', '时间错觉', '文字陷阱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 30,
      hintCost: 10,
      items: ['酒保不是想伤人。', '男人要水有别的目的。', '惊吓解决了症状。'],
    },
    tags: ['日常怪谈', '餐桌谜案', '文字陷阱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 30,
      hintCost: 10,
      items: ['先别默认他们是人。', '名字在制造错觉。', '水和玻璃更重要。'],
    },
    tags: ['人偶误认', '血色密室', '文字陷阱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 30,
      hintCost: 10,
      items: ['车不一定能上路。', '旅馆也许是规则。', '破产发生在游戏里。'],
    },
    tags: ['游戏陷阱', '文字陷阱', '日常怪谈'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 30,
      hintCost: 10,
      items: ['两个人不是全部。', '诚实不代表矛盾。', '考虑更大的出生组合。'],
    },
    tags: ['医院诡事', '文字陷阱', '日常怪谈'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 30,
      hintCost: 10,
      items: ['识别靠身体细节。', '他们的来源很特殊。', '注意出生方式差异。'],
    },
    tags: ['童话黑箱', '身体代价', '文字陷阱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 30,
      hintCost: 10,
      items: ['别急着设定光线。', '关键在发生时段。', '黑色不等于看不见。'],
    },
    tags: ['雨夜车祸', '时间错觉', '日常怪谈'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['叙述者以灵魂视角叙述。', '盲人的感知不可靠。', '盲人有导盲犬。'],
    },
    tags: ['血色密室', '陌生来客', '身体代价'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['村子不是普通村子。', '热和渴源于死因。', '那几口井意味着轮回。'],
    },
    tags: ['童话黑箱', '时间错觉', '雨夜车祸'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['三个孩子分别回答', '愿望被字面实现。', '圣诞老人是屠夫。'],
    },
    tags: ['童话黑箱', '身体代价', '血色密室'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['规则曾被误触发。', '平安夜可能是假象。', '生日动作重合了禁忌。'],
    },
    tags: ['童话黑箱', '时间错觉', '文字陷阱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['现代说法藏着名著。', '兄弟身份要换套语境。', '对面大哥能收场。'],
    },
    tags: ['童话黑箱', '文字陷阱', '游戏陷阱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['按摩师少了一种判断。', '不一定活人才能动。', '叫声来自动物。'],
    },
    tags: ['血色密室', '餐桌谜案', '身体代价'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['称谓和年龄不匹配。', '另一个爸爸不是父亲。', '妹妹想要替代品。'],
    },
    tags: ['人偶误认', '血色密室', '日常怪谈'],
  ...
  },
  {
    ...
    truth:
      '高老爷子有五个儿子：高老大、高老二、高老三、高老四、高老五。高老大为了独占遗产，先杀死高老三的儿子并整容成他的样子，随后在高老爷子死后杀害几个兄弟。为了伪造自己也死亡、并制造恶魔分尸的假象，他把四具尸体切割平移，拼成看似五具尸体的现场。所谓五兄弟各缺不同部位，是因为身体部件被错位组合，现场那个“老三的儿子”其实就是高老大。',
    difficulty: 'hard',
    hints: {
      questionLimit: 60,
      hintCost: 20,
  ...
  },
  {
    ...
    title: '奇怪的声音',
    surface:
      '之前的支教走了，我被派去山里支教，借宿在村长家。他家门口贴着奇怪黄纸，每晚都有有规律的沉闷咚咚声。我记下数字 96924482622454。三天后声音消失，我也明白那串数字代表五个字，但是一切都晚了。发生了什么？',
    truth:
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['房间不在家里。', '鞋声是动物发出的。', '保安害怕秘密暴露。'],
    },
    tags: ['血色密室', '文字陷阱', '身体代价'],
  ...
  },
  {
    ...
    title: '宿舍',
    surface:
      '天气很热，老大在宿舍门口吃冰棍，老三刚吃完饭，在远处探头看着我们。封寝后我准备睡觉，朦胧中听到老四一声惨叫。发生了什么？',
    truth:
      '这不是普通宿舍，而是一座诡异雪山上的帐篷。“我”是挑战雪山的登山客，发现帐篷外有两具自己的尸体：一具被山巅落下的冰锥贯穿喉咙，像在吃冰棍；另一具陷在雪流沙里，只露出头，嘴角有进食痕迹，说明曾吃掉另一个“我”，也就是老二。我逃不出这座雪山，最终失温死在帐篷里。弥留时听见新来的“老五”看到这些尸体后惨叫，循环又开始了。',
    difficulty: 'hard',
    hints: {
      questionLimit: 60,
      hintCost: 20,
    ...
    tags: ['荒野遗物', '时间错觉', '身体代价'],
    summary: '宿舍日常被映射到雪山循环，需要重解“老大老三老四”的身份。',
    source: {
      platform: '抖音',
      authorName: '许二木',
      originalUrl:
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['亲属称谓不可靠。', '胃病暴露了怪癖。', '人格切换藏着试探。'],
    },
    tags: ['人偶误认', '身体代价', '文字陷阱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['我是红绿色盲。', '礼物的表象都是假的。', '敲门声的不是活人。'],
    },
    tags: ['童话黑箱', '血色密室', '身体代价'],
  ...
  },
  {
    ...
    title: '兄妹',
    surface:
      '我家楼上住着一对兄妹，哥哥开朗，妹妹沉默寡言却是知名主播。我每天看她直播，很喜欢她。终于有一天，我鼓起勇气去了她家，她注意到我了，我大叫一声。从此她每天除了直播都会陪着我。为什么？',
    truth:
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['直播身份先别相信。', '在她家我看到了真相。', '陪伴发生在死亡之后。'],
    },
    tags: ['人偶误认', '血色密室', '日常怪谈'],
  ...
  },
  {
    ...
    title: '期末考试',
    surface:
      '转学后的一个月里，所有同学都觉得我精神不正常并排挤我，只有我同桌和老师似乎不这么想。期末考试成绩出来后，我才明白自己真的不正常。为什么？',
    truth:
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['我会对着空气交流。', '老师知道旧传闻。', '榜单缺少关键名字。'],
    },
    tags: ['医院诡事', '日常怪谈', '人偶误认'],
  ...
  },
  {
    ...
    title: '牧场',
    surface:
      '妈妈去世后留给我一座荒废牧场，她的面容在我的记忆里逐渐模糊。第二天牧场里多了一只鸡，第三天多了一头牛，第四天多了一只羊。一个月后我明白了规律，于是做了一个疯狂决定。第二天牧场里出现一个年轻女人，我看到后疯了。为什么？',
    truth:
  ...
  },
  {
    ...
    truth:
      '八年前，地球轨迹偏移，两个平行世界短暂交错。一个孕妇腹中的胎儿被转移到平行世界同位体腹中：这个世界的她误以为流产并家庭破裂，另一个世界的她和她老公则以为生下双胞胎。八年后，某种力量开始校正偏移，让两个世界重新平行。哥哥被送回原本世界，于是出现在衣柜里；另一个世界的弟弟则逐渐失去哥哥存在过的痕迹，所有人都不再记得哥哥，只有他还残留记忆并被认为患有臆想症。',
    difficulty: 'hard',
    hints: {
      questionLimit: 60,
      hintCost: 20,
    ...
    tags: ['时间错觉', '童话黑箱', '人偶误认'],
    summary:
      '衣柜里的陌生孩子牵出平行世界错位，需要同时理解两个家庭的记忆差异。',
    source: {
      platform: '抖音',
      authorName: '许二木',
      originalUrl:
  ...
  },
  {
    ...
    title: '送别',
    surface:
      '战争快胜利了，不需要守夜，那晚我睡的很早。午夜时，我朦胧中听到枪炮声。早上醒来又听到清脆的金属碰撞声，一前一后两个脚步声。家门口围满人，地上有五具尸体。查明真相后，我跟村民一起继续把其中三具送到了该去的地方。发生了什么？',
    truth:
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['铃声属于送行方式。', '尸体数量属于交战双方。', '脚步声是一老一少。'],
    },
    tags: ['绝境誓言', '荒野遗物', '童话黑箱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['声音不是来自牲口。', '敲门也是求救。', '受害者失去正常行走方式。'],
    },
    tags: ['日常怪谈', '身体代价', '血色密室'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['回应不是女子说的。', '门口有人代她取餐。', '危险已经在屋里。'],
    },
    tags: ['陌生来客', '日常怪谈', '文字陷阱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['我因为二哥的死感到孤独。', '我追求原来的排列。', '大哥被分成两半。'],
    },
    tags: ['身体代价', '日常怪谈', '血色密室'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['雨声不是来自自然现象。', '闪光来自人为动作。', '消息证明她被盯上。'],
    },
    tags: ['雨夜车祸', '日常怪谈', '时间错觉'],
  ...
  },
  {
    ...
    title: '清洁工',
    surface:
      '一名女子晚上进入昏暗公厕，看见里面有个清洁工在拖地，便打了声招呼后匆忙进隔间。第二天警察因同一时间厕所发生杀人案找到她，那个时间段没有其他人出现，警察质问她为什么当时没有报警。为什么她没发现异常？',
    truth:
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['拖地画面要重看。', '昏暗掩盖了姿势。', '清洁工具不是工具。'],
    },
    tags: ['血色密室', '日常怪谈', '人偶误认'],
