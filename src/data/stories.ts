...
export const stories: Story[] = [
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['亲属称谓不可靠。', '胃病暴露了身体秘密。', '人格切换藏着试探。'],
    },
    tags: ['人偶误认', '身体代价', '文字陷阱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['颜色判断要小心。', '礼物都是现场错认。', '敲门声来自门外上方。'],
    },
    tags: ['童话黑箱', '血色密室', '身体代价'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['直播身份先别相信。', '床底视角很关键。', '陪伴发生在死亡之后。'],
    },
    tags: ['人偶误认', '血色密室', '日常怪谈'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['同桌存在感不一致。', '老师知道旧传闻。', '榜单缺少关键名字。'],
    },
    tags: ['医院诡事', '日常怪谈', '人偶误认'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['规律和吃有关。', '复活想法太字面。', '出现的人指向自身来源。'],
    },
    tags: ['童话黑箱', '人偶误认', '时间错觉'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['铃声属于送行方式。', '尸体数量分成两边。', '脚步声是一老一少。'],
    },
    tags: ['绝境誓言', '荒野遗物', '童话黑箱'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 60,
      hintCost: 20,
      items: ['声音不是来自牲口。', '敲门也是求救。', '受害者失去正常方式。'],
    },
    tags: ['日常怪谈', '身体代价', '血色密室'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['床位空缺很重要。', '他追求原来的排列。', '大哥被分成位置。'],
    },
    tags: ['身体代价', '日常怪谈', '血色密室'],
  ...
  },
  {
    ...
    hints: {
      questionLimit: 45,
      hintCost: 15,
      items: ['天气判断可能错了。', '闪光来自人为动作。', '消息证明她被盯上。'],
    },
    tags: ['雨夜车祸', '日常怪谈', '时间错觉'],
