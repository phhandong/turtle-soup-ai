...
export const stories: Story[] = [
  {
    ...
    source: {
      ...
      authorName: "未标注",
      originalUrl: "https://www.yesnopuzzle.com/en/blog/origins-turtle-soup-puzzle",
  ...
  },
  {
    id: "melting-snowman",
    title: "草地上的煤块、胡萝卜和围巾",
    surface: "晴天的草地上有几块煤、一根胡萝卜和一条围巾。没有人把它们放在那里。为什么？",
    truth:
  ...
  },
  {
    id: "unopened-package",
    title: "田野里的未打开包裹",
    surface: "一个男人死在田野中央，旁边有一个没有打开的包裹。田野里没有其他人或动物。男人是怎么死的？",
    truth:
  ...
  },
  {
    id: "puddle-of-water",
    title: "空房间里的一摊水",
    surface: "一个男人被发现吊死在没有窗户的空房间里，门从里面锁着。房间里除了他和地上的一摊水，几乎什么也没有。他是怎么做到的？",
    truth:
    ...
    source: {
      ...
      originalUrl: "https://www.puzzleprime.com/puzzles/brain-teasers/lateral/puddle-of-water/",
      license: "公开网页资料改写，原始版权归来源站点",
      collectedAt: "2026-05-04",
  ...
  },
  {
    id: "bar-water-gun",
    title: "酒吧里的水和枪",
    surface: "一个男人走进酒吧，向酒保要一杯水。酒保没有给水，而是拿出一把枪指着他。男人却说了声谢谢，然后离开。为什么？",
    truth:
  ...
  },
  {
    ...
    title: "安东尼和克莉奥佩特拉之死",
    surface: "安东尼和克莉奥佩特拉被发现死在房间地板上，旁边有碎玻璃和一摊水。两者身上没有伤口，也没有中毒。发生了什么？",
    truth:
  ...
  },
  {
    ...
    title: "邮包里的手臂",
    surface: "一个男人收到邮包，里面仔细包着一条人类手臂。他检查后重新包好，寄给另一个男人。第二个男人也检查了它，然后把它带到树林里埋掉。为什么？",
    truth:
    ...
    source: {
      ...
      originalUrl: "https://puzzlefry.com/puzzles/the-arm-of-the-postal-service/",
      license: "公开网页资料改写，原始版权归来源站点",
      collectedAt: "2026-05-04",
  ...
  },
  {
    ...
    title: "推车到旅馆后破产",
    surface: "一个男人推着自己的车前进。到了旅馆前，他立刻宣布自己破产。为什么？",
    truth:
    ...
    source: {
      ...
      originalUrl: "https://puzzlefry.com/puzzles/man-pushes-car-stops-front-hotel-puzzle/",
      license: "公开网页资料改写，原始版权归来源站点",
      collectedAt: "2026-05-04",
  ...
  },
  {
    ...
    title: "同日同刻出生却不是双胞胎",
    surface: "两个孩子有同一个母亲和父亲，出生日期、年份甚至出生时间都一样，长得也很像。但他们诚实地说自己不是双胞胎。为什么？",
    truth:
    ...
    source: {
      platform: "Puzzle Prime",
      authorName: "Unknown Author",
      originalUrl: "https://www.puzzleprime.com/puzzles/brain-teasers/lateral/not-twins/",
      license: "公开网页资料改写，原始版权归来源站点",
      collectedAt: "2026-05-04",
  ...
  },
  {
    ...
    title: "天堂里认出亚当和夏娃",
    surface: "一个人死后来到天堂，看见那里有无数年轻男女。他从未见过亚当和夏娃，却立刻认出了他们。为什么？",
    truth:
  ...
  },
  {
    ...
    title: "黑衣人与黑车",
    surface: "一个男人全身穿黑，走在没有路灯的小路上。一辆没有开灯的黑色汽车向他驶来，却及时停下，没有撞到他。司机是怎么看到他的？",
    truth:
    ...
    source: {
      ...
      authorName: "Unknown",
      originalUrl: "https://www.csun.edu/science/ref/questions/lateral_thinking/index.htm",
      license: "公开网页资料改写，原始版权归来源站点",
      collectedAt: "2026-05-04",
